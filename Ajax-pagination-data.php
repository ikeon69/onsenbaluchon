...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <img src="<?php echo base_url('assets/frontend/img/logo_onsenbaluchonnew2.png'); ?>" class="img-responsive" alt="logo onsenbaluchon">
                </a>
            </div>
    ...
    <header class="video">
        <div class="overlay embed-responsive" ></div>
        <div class="intro-content">

            <img src="<?php echo base_url('assets/frontend/img/logo_onsenbaluchonnew.png'); ?>" class="img-responsive img-centered" alt="logo onsenbaluchon">
    ...
    <section id="videos">
        ...
        <div class="container-fluid text-center wow fadeIn">
            <img src="<?php echo base_url('assets/frontend/img/onsenbaluchon-banniere4.jpg'); ?>"class="img-responsive img-centered" alt="banniere onsenbaluchon"/>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="portfolio-filter">
                            <ul id="filters" class="clearfix">
                                ...
                                <li>
                                    <span class="filter active" data-filter="<?php  foreach($categories as $cat) { echo $cat->slug.' '; } ?>">Toutes</span>
                                </li>
                    ...
                    <div class="col-lg-12">
                        <div id="portfoliolist">
                            ...
                            $compteur=1;
                              ...
                              if(!empty($allVideosFront)): foreach($allVideosFront as $vid) :
    ...
    <div class="container-fluid text-center">
        <h2 class="grdbtnsabonner"><a href="https://www.youtube.com/channel/UCRGFxAYwNzTjlUApOS7sw3w" class="btn btn-block btn-full-width" target="_blank"><i class="fa fa-youtube fa-fw fa-2x"></i>S'ABONNER A ON S'EN BALUCHON MAINTENANT!</a></h2>
    </div>
    <section id="acteurs" class="bg-gray">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2>LES ACTEURS DE</br> ON S'EN BALUCHON !</h2>
...
<!-- Article -->
            <article>
                ...
                <ul class="thumbnails about-items">
                    ...
                    <?php foreach($equipes as $equipe) { ?>
                        <li class="col-md-3 col-sm-4 col-xs-6 <?php if ($compteur==5){echo 'col-md-offset-1';} ?> center">
                             <div class="item">
                                <!-- Team member image -->
                                <img class="img-circle img-responsive" src="<?php echo $equipe->image; ?>" alt="<?php echo $equipe->surname; ?>">
                            ...
                            <h5><?php echo $equipe->roles; ?></h5></br></br>
    ...
    <section id="contact" class="img-responsive img-centered" >
        <div class="container wow fadeIn img-responsive">
            <div class="row">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Nom</label>
                                <input type="text" class="form-control" placeholder="Nom" id="name" required data-validation-required-message="Veuillez saisir votre nom s'il vous plaît">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="email" class="form-control" placeholder="Adresse Email" id="email" required data-validation-required-message="Veuillez saisir une adresse email s'il vous plaît.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="téléphone" id="phone" required data-validation-required-message="Veuillez saisir un numéro de téléphone.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Message</label>
                                <textarea rows="4" class="form-control" placeholder="Message" id="message" required data-validation-required-message="Veuillez saisir votre message."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <button type="submit" class="btn btn-outline-dark envoyer">Envoyer</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-lg-12">
                    <ul class="list-inline">
                     ...
                     <div class="scroll-up page-scroll">
                        <a class="btn page-scroll" href="#page-top"><i class="fa fa-angle-up"></i></a>
                    </div>
                </div>
            </div>
    ...
    <!-- Example Modal 1 -->
    <?php foreach ($allVideosFront as $vid) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-lg-offset-1">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="<?php echo $vid->trailer; ?>" autoplay="true" allowfullscreen ></iframe>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-lg-offset-2">
                                ...
                                <form action="<?php echo site_url('comments/creer/'.$vid->id); ?>" method="post">
                                    ...
                                    <button type="submit" class="btn btn-default envoyer">Envoyer</button>
    ...
    <script>
        ...
        $(function() {
            ...
            $("header.video").background({
                ...
                source: {
                     video: '<?php echo $dernierevideo->trailer; ?>',
            ...
            $("header.video").mouseover(function(){
              ...
              $(".close-modal").on('click',function(){
                alert('vous avez cliqué pour fermer la modal !');

                 $("modal-body").mouseout("pause");

            });////

               $("video-stream").mouseout(function(){
                $("video-stream").background("pause");
            });////
        }); 
